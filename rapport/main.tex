...
Célèble code C en forme de donut ; par Andy Sloane :
\begin{lstlisting}[language=C, caption=C donut]
                 k;double sin()
         ,cos();main(){float A=
...
A compiler avec gcc -o donut donut.c -lm. Nécessite un terminal ANSI ou VT100 pour fonctionner.
