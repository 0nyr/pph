...
Au regard de ces réflexions, il apparait que le code peut être de l'art. La notion de code doit alors s'entendre dans la complexité de ce qu'elle implique de même que la notion d'art. Un parallèle intéressant consiste alors à comparer le code et la musique, puisque la musique est souvent considérée comme un art ancien et établi.
